...
This highlights which pathways were most commonly used between 2024-01-31 and `r max(df_measures$interval_end)`.

**Table 2**. Clinical conditions recorded in Pharmacy First consultations grouped by sex in OpenSAFELY-TPP between 2024-01-31 and `r max(df_measures$interval_end)`.
...
**Table 3**. Top ten medications recorded in Pharmacy First consultations between 2024-01-31 and `r max(df_consultation_med_counts$interval_end)`.
