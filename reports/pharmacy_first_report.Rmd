...
if (!is.null(df_demographics_table)) {
  write_csv(df_demographics_table, here("output", "data", "df_demographics_table.csv"))
...
write_csv(df_pf_consultations, here("output", "data", "df_pf_consultations.csv"))
...
ggsave(here("output", "figures", "figure1.png"), plot_pf_consultations, width = 10, height = 8, create.dir = TRUE)
```
...
pf_sex
write_csv(df_measures, here("output", "data", "df_measures.csv"))
ggsave(here("output", "figures", "figure2sex.png"), pf_sex, width = 10, height = 4)
```
...
pf_age
ggsave(here("output", "figures", "figure3age.png"), pf_age, width = 10, height = 4)
```
...
pf_imd
ggsave(here("output", "figures", "figure4imd.png"), pf_imd, width = 10, height = 4)
```
...
pf_region
ggsave(here("output", "figures", "figure5region.png"), pf_region, width = 10, height = 4)
```
...
pf_ethnicity
ggsave(here("output", "figures", "figure6ethnicity.png"), pf_sex, width = 10, height = 4)
```
...
write_csv(df_pf_descriptive_stats, here("output", "data", "df_pf_descriptive_stats.csv"))
...
ggsave(here("output", "figures", "figure7.png"), plot_pf_med_condition_linkage, width = 10, height = 4)
```
...
if (!is.null(df_clinical_pathways_by_sex)) {
  ...
  write_csv(df_clinical_pathways_by_sex, here("output", "data", "df_clinical_pathways_by_sex.csv"))
} else {
...
write_csv(df_pf_and_non_pf_med_counts, here("output", "data", "df_pf_and_non_pf_med_counts.csv"))
