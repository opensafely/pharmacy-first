...
This OpenSAFELY report presents real-time analyses of the Pharmacy First service using data from OpenSAFELY-TPP. It is designed to support policymakers and clinicians in making timely, data-driven decisions to enable targeted improvements in service delivery.
...
The code for this report can be found in the OpenSAFELY Pharmacy First [repository](https://github.com/opensafely/pharmacy-first). 
