...
```{r plot-pf-consultations-by-region, message=FALSE, warning=FALSE, fig.height=4.25, fig.width=10, fig.cap="Figure 5. Monthly count of patients with a Pharmacy First consultation code in OpenSAFELY-TPP broken down by region."}
df_measures %>%
  filter(between(interval_start, as.Date("2024-02-01"), as.Date("2025-02-01"))) |>
  filter(measure_desc == "pharmacy_first_services") %>%
