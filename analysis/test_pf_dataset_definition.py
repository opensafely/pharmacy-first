...
test_data = {
    ...
    1: {
        "patients": {"date_of_birth": date(2023, 1, 1), "sex": "female"},
        "clinical_events": [
            {},
        ],
        "ethnicity_from_sus": {"code": "A"},
    ...
    3: {
        "patients": {"date_of_birth": date(2000, 1, 1), "sex": "male"},
        "clinical_events": [
            {
    ...
    # Expected in population (test for multiple diagnosis exclusion -acute otitis)
    # Male, 1 years old, THREE otitis media diagnoses
    4: {
        "patients": {"date_of_birth": date(2023, 1, 1), "sex": "male"},
        "clinical_events": [
            {
                # 1st otitis diagnosis
                "date": date(2024, 10, 7),
                "snomedct_code": "3110003",
            },
            {
                # 2nd otitis diagnosis
                "date": date(2024, 10, 8),
                "snomedct_code": "3110003",
            },
            {
                # 3rd otitis diagnosis
                "date": date(2024, 10, 9),
                "snomedct_code": "3110003",
            },
        ],
    ...
    # Expected in population (test for multiple diagnosis exclusion - uti)
    # Female, 24 year old with 3 uti diagnoses
    4: {
        "patients": {"date_of_birth": date(2000, 1, 1), "sex": "female"},
        "clinical_events": [
            {
    ...
    # Expected in population (test for under 16 pregnancy exclusion)
    # Female, 14 years old, PREGNANT
    5: {
        "patients": {"date_of_birth": date(2010, 1, 1), "sex": "female"},
        "clinical_events": [
            {
                # Pregnancy code
                "date": date(2024, 10, 3),
