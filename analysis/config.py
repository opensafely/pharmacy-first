...
# Measure: measures_definition_pf_breakdown.py -- UPDATE FOR MONTHLY DASHBOARD
# Timeframe: 01/11/2023 - 31/10/2025
start_date_measure_pf_breakdown = "2023-11-01"
monthly_intervals_measure_pf_breakdown = 24
...
# Measure: measures_definition_pf_descriptive_stats.py -- UPDATE FOR MONTHLY DASHBOARD
# Timeframe: 01/11/2023 - 31/10/2025
start_date_measure_descriptive_stats = "2023-11-01"
monthly_intervals_measure_descriptive_stats = 24

# Measure: measures_definition_pf_consultation_pf_counts.py -- UPDATE FOR MONTHLY DASHBOARD
# Timeframe: 01/11/2023 - 31/10/2025
start_date_measure_med_counts = "2023-11-01"
monthly_intervals_measure_med_counts = 24
